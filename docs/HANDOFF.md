# STRATA (v2) — project handoff

Research-peptides (v2); a GPU point-cloud morphs between shapes, with chromatogram motifs.

- **Live preview port:** `:8604`  (host `https://andreidutescus-macbook-pro.tailb4cf4e.ts.net:8604`; needs Tailscale + passcode — ask the owner)
- **Stack:** Vite + React 18 + Three.js + GSAP + Lenis. Plain JS (JSX), hand-written CSS. No TypeScript, no Tailwind.
- **Signature animation:** src/three/StrataParticles.jsx + AtelierStage.jsx; store: src/three/vialStore.js
